...
\fixed
	\item Fixed a bug in 2.4.1 and 2.5.0 where a version with a date and no
		version number would display the date twice, like ``\textbf{2024-09-17}
		(2024-09-17)''. Now, the date will correctly only be shown once.
